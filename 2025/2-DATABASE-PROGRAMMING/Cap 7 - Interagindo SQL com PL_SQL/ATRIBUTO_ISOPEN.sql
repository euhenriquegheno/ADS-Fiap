-- Script que trabalha com o conceito do atributo de cursor %FOUND, %NOTFOUND -- %ROWCOUNT e %ISOPEN
SET SERVEROUTPUT ON;
...
BEGIN
    -- Verifica se o cursor está aberto, se não estiver, abre-o
    IF NOT C_VALOR_TOTAL_MEDIA_VENDAS_CLIENTE%ISOPEN THEN
    ...
    -- Fechamos o cursor para liberar a memória, mas apenas se estiver aberto
    IF C_VALOR_TOTAL_MEDIA_VENDAS_CLIENTE%ISOPEN THEN
